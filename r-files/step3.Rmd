...
# Results
We 
Our results indicate that a multiple linear regression model with the factors FAVC, CAEC, SCC, CALC, FCVC, and CH2O where the age is greater than 26 is ideal. Under the adjusted model summary statistics, the factors are all significant with p-value < 0.05. 
