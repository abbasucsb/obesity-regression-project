...
In this model, we include predictors such as the frequency of consuming high-caloric foods (FAVC), eating between meals (CAEC), alcohol consumption (CALC), and daily calorie monitoring (SCC), water intake (CH2O), vegetable consumption (FCVC), and frequecy of physical exercise (FAF).

### Hypothesis
We would like to focus on two key research questions:
1) Does frequency of physical activity have any significant impact on BMI?
...
\end{aligned}
$$
2) Do particular consumption habits have any significant impact on BMI?
$$
\begin{aligned}
H_0&: \text{Frequency of physical activity has no significant impact on BMI} \\
H_A&: \text{Frequency of physical activity has a significant impact on BM}
\end{aligned}
$$
